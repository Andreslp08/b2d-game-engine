...
// export class CollisionSystem implements Updatable {
...
// 			if (!entity.hasComponent(DynamicBody) || !entity.hasComponent(Collider)) continue;

// 			const rigidBodyA = entity.getComponent(DynamicBody);
